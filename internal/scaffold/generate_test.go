...
func TestFileGenerator_Copy(t *testing.T) {
	t.Run("From Doesn't Exist", func(t *testing.T) {
		gen := setup(t)

		err := gen.Copy("non-existent", "path.json", nil)
		assert.Error(t, err)
		assert.ErrorContains(t, err, "unable to copy file")
	})
	...
	t.Run("Copied", func(t *testing.T) {
		...
		err := afero.WriteFile(gen.fs, srcPath, content, os.ModePerm)
		require.NoError(t, err)

		dstPath := "dest.json"
		err = gen.Copy(srcPath, dstPath, WithoutNotice())
		assert.NoError(t, err)

		got, readErr := afero.ReadFile(gen.fs, dstPath)
		assert.NoError(t, readErr)
...
func TestFileGenerator_CopyFromEmbed(t *testing.T) {
	t.Run("From Doesn't Exist", func(t *testing.T) {
		...
		err := gen.CopyFromEmbed(testEmbed, "non-existent.json", "path.json", nil)
		assert.Error(t, err)
		assert.ErrorContains(t, err, "unable to copy embedded file")
	})

	t.Run("Copied", func(t *testing.T) {
		gen := setup(t)

		srcPath := "testdata/source.json"
		dstPath := "dest.json"

		err := gen.CopyFromEmbed(testEmbed, srcPath, dstPath, WithoutNotice())
		assert.NoError(t, err)

		got, readErr := afero.ReadFile(gen.fs, dstPath)
		assert.NoError(t, readErr)

		want, err := testEmbed.ReadFile(srcPath)
		assert.NoError(t, err)
	...
	t.Run("With Notice", func(t *testing.T) {
		...
		srcPath := "testdata/source.txt"
		dstPath := "dest.txt"

		err := gen.CopyFromEmbed(testEmbed, srcPath, dstPath)
		assert.NoError(t, err)
		...
		wantWithNotice := "# Code generated by webkit; DO NOT EDIT.\n" + string(want)
		assert.Equal(t, wantWithNotice, string(got))
	})
}
...
func TestFileGenerator_Code(t *testing.T) {
	t.Parallel()
...
`
		...
		err := gen.Code(path, input)
		require.NoError(t, err)

		got, readErr := afero.ReadFile(gen.fs, path)
		require.NoError(t, readErr)

		// Notice should be automatically prepended
		want := `// Code generated by webkit; DO NOT EDIT.
package version
...
`
	...
	t.Run("Empty Code With Notice", func(t *testing.T) {
		t.Parallel()
		...
		// Notice should still be added even for empty content
		want := "// Code generated by webkit; DO NOT EDIT.\n"
		assert.Equal(t, want, string(got))
	})
}
