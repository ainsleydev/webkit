...
[![Status]({{ .Outputs.Monitoring.PeekapingEndpoint }}/api/v1/badge/{{ (index .Outputs.Monitoring.HTTPMonitors (keys .Outputs.Monitoring.HTTPMonitors | first)).ID }}/status)]({{ .Outputs.Monitoring.StatusPageURL }})
{{- end }}
