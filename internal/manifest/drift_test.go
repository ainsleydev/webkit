...
func TestDetectDrift(t *testing.T) {
	...
	t.Run("Mixed Drift Scenarios", func(t *testing.T) {
		...
		err = afero.WriteFile(fs, ".env.development", []byte("user modified config"), 0644)
		require.NoError(t, err)
	...
	t.Run("No Drift When All Files Match", func(t *testing.T) {
		...
		err := afero.WriteFile(fs, "file1.txt", content, 0644)
		require.NoError(t, err)
		err = afero.WriteFile(fs, "file2.txt", content, 0644)
		require.NoError(t, err)
