...
func globalsMiddleware[T any](client *payloadcms.Client, store cache.Store, global string, opts ...payloadcms.RequestOption) webkit.Plug {
	return func(next webkit.Handler) webkit.Handler {
		return func(c *webkit.Context) error {
			...
			_, err := client.Globals.Get(ctx, payloadcms.Global(global), t, opts...)
			if err != nil {
