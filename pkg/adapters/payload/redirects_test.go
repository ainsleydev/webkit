	...
	tt := map[string]struct {
		...
		"API error returns nil": {
			...
			mock: func(cols *payloadfakes.MockCollectionService, _ cache.Store) {
				cols.ListFunc = func(ctx context.Context, collection payloadcms.Collection, params payloadcms.ListParams, out any, opts ...payloadcms.RequestOption) (payloadcms.Response, error) {
